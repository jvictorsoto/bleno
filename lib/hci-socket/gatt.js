...
Gatt.prototype.setServices = function(services, genBaseServices) {
  ...
  var allServices = (typeof genBaseServices !== 'undefined' && !genBaseServices) ? services : baseServices.concat(services);
        ...
        if (data.length !== 2) {
          ...
          if (value & 0x0003) {
            ...
            if (handleAttribute.emit) {
              handleAttribute.emit('subscribe', this._mtu - 3, updateValueCallback, valueHandle - 1);
            }
          } else {
